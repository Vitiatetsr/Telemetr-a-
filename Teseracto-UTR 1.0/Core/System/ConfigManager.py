...
class ConfigManager:
    ...
    def cargar_config_general(cls) -> Dict[str, Any]:
        ...
        # Usar PathManager para obtener ruta de almacenamiento
        storage_path = path_manager.get_storage_path()
        cfg.setdefault("storage_path", str(storage_path))
    ...
    def guardar_config_general(cls, config: Dict[str, Any]) -> None:
        ...
        # Validar y asegurar ruta USB usando PathManager
    ...
    def cargar_config_ftp(cls) -> Dict[str, Any]:
        ...
        cfg.setdefault("secure", True)
        
        # CORRECCIÓN: Usar logging en lugar de error_handler
    ...
    def guardar_config_ftp(cls, config: Dict[str, Any]) -> None:
        ...
        config_path = path_manager.get_config_path("ftp_config.json")  # MODIFICADO: usa PathManager
        cls._guardar_archivo(config_path, config)
    ...
    def cargar_config_sms(cls) -> Dict[str, Any]:
        ...
        config_path = path_manager.get_config_path("sms_config.json")  # MODIFICADO: usa PathManager
        cfg = cls._cargar_archivo(config_path)
    ...
    def cargar_config_login(cls) -> Dict[str, Any]:
        ...
        config_path = path_manager.get_config_path("login_config.json")  # MODIFICADO: usa PathManager
        cfg = cls._cargar_archivo(config_path)
    ...
    def cargar_config_sensor(cls) -> Dict[str, Any]:
        ...
        config_path = path_manager.get_config_path("sensor_config.json")  # MODIFICADO: usa PathManager
        cfg = cls._cargar_archivo(config_path)
    ...
    def guardar_config_alertas(cls, alertas: Dict[str, Any]) -> None:
        ...
        cfg["alertas"] = alertas
        config_path = path_manager.get_config_path("config.json")  # MODIFICADO: usa PathManager
        cls._guardar_archivo(config_path, cfg)
